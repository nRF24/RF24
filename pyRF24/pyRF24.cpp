...
BOOST_PYTHON_MODULE(python-nrf24l01)
{
    ...
    bp::class_<RF24>("RF24", bp::init<uint8_t, uint8_t>((bp::arg("_cepin"), bp::arg("_cspin"))))
        ...
        .def("disable_crc", &RF24::disableCRC)
        ...
        .def("get_crc_length", &RF24::getCRCLength)
        .def("get_data_rate", &RF24::getDataRate)
        .def("get_dynamic_payload_size", &RF24::getDynamicPayloadSize)
        .def("get_pa_level", &RF24::getPALevel)
        ...
        .def("set_crc_length", &RF24::setCRCLength, (bp::arg("length")))
        .def("set_channel", &RF24::setChannel, (bp::arg("channel")))
        .def("set_data_rate", &RF24::setDataRate, (bp::arg("speed")))
        .def("set_pa_level", &RF24::setPALevel, (bp::arg("level"), bp::arg("lna_enable") = 1))
